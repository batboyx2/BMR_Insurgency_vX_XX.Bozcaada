...
[] execVM "bsmrk_zeus_distribute.sqf";
// Server Functions //
...
[] spawn {
	...
	if (!isNil "MHQ_3") then {
		...
		if (INS_MHQ_enabled) then {
			...
			_nul = [MHQ_3, 60, 0.01, {_this setVariable["persistent",true]; _VarName = "MHQ_3"; _veh setVehicleVarName _VarName; _veh Call Compile Format ["%1=_This ; PublicVariable ""%1""",_VarName]; [_this] call anti_collision; INS_MHQ_killed = "MHQ_3"; publicVariable "INS_MHQ_killed";}] execVM "vehrespawn.sqf";
		};
	};
