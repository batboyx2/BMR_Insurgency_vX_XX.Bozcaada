...
null = [["civmkr1"],[20,1,CivProbability],[16,0,CivProbability],[0,0],[0],[0],[0,0],[7,1,500,CIVILIAN]] call EOS_Civ_Spawn;
null = [["civmkr2"],[5,1,CivProbability],[4,0,CivProbability],[0,0],[0],[0],[0,0],[7,1,500,CIVILIAN]] call EOS_Civ_Spawn;